...
public static class ThreadsApiTypes
{
	...
	)
	{
		...
		internal static ThreadsListResponse ReadFromReader(ref Utf8JsonReader reader)
		{
			...
			string v1 = null!;
			ThreadsListResponseForum? v2 = default;
			long v3 = default;
			ThreadsListResponseLinks v4 = null!;
			...
			while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
			{
				...
				else if (reader.ValueTextEquals("tabTitle"u8))
				{
					reader.Read();
					v1 = reader.GetString()!;
				}
				...
				{
					reader.Read();
					v2 = reader.TokenType == JsonTokenType.Null ? null : ThreadsListResponseForum.ReadFromReader(ref reader);
				}
				...
				{
					reader.Read();
					v4 = reader.TokenType == JsonTokenType.Null ? null! : ThreadsListResponseLinks.ReadFromReader(ref reader);
				}
			...
			return new ThreadsListResponse(v0, v1, v2, v3, v4, v5);
		}
	}
