...
)
{
	...
	public sealed record UsersFindParams
	{
		...
		public void WriteTo(Utf8JsonWriter writer)
		{
			...
			{
				writer.WritePropertyName("custom_fields"u8);
				writer.WriteStartObject();
				foreach (var __wkv in CustomFields)
				{
					writer.WritePropertyName(__wkv.Key);
					writer.WriteStringValue(__wkv.Value);
				}
				writer.WriteEndObject();
			}
			if (FieldsInclude is not null)
	...
	public sealed record UsersCurrentParams
	{
		/// <summary>
		/// List of fields to include.
		/// </summary>
	...
	public sealed record UsersCurrentResponse(
	...
	)
	{
		...
		/// <summary>Deserialize from raw UTF-8 JSON bytes — no JsonDocument, no reflection.</summary>
		public static UsersCurrentResponse ReadFrom(ReadOnlyMemory<byte> json)
		{
			var reader = new Utf8JsonReader(json.Span);
			reader.Read(); // advance to StartObject
			return ReadFromReader(ref reader);
		...
		internal static UsersCurrentResponse ReadFromReader(ref Utf8JsonReader reader)
		{
			...
			return new UsersCurrentResponse(v0, v1);
		}
	}
	...
	public sealed record UsersEditBody
	{
		...
		public void WriteTo(Utf8JsonWriter writer)
		{
			...
			{
				writer.WritePropertyName("user_title"u8);
				writer.WriteStringValue(UserTitle);
			}
			if (DisplayGroupId is not null)
			{
				writer.WritePropertyName("display_group_id"u8);
				writer.WriteNumberValue(DisplayGroupId.Value);
			}
			if (DisplayIconGroupId is not null)
			{
				writer.WritePropertyName("display_icon_group_id"u8);
				writer.WriteNumberValue(DisplayIconGroupId.Value);
			}
			if (DisplayBannerId is not null)
			{
				writer.WritePropertyName("display_banner_id"u8);
				writer.WriteNumberValue(DisplayBannerId.Value);
			}
			if (ConvWelcomeMessage is not null)
			{
				writer.WritePropertyName("conv_welcome_message"u8);
				writer.WriteStringValue(ConvWelcomeMessage);
			}
			if (UserDobDay is not null)
			{
				writer.WritePropertyName("user_dob_day"u8);
				writer.WriteNumberValue(UserDobDay.Value);
			}
			if (UserDobMonth is not null)
			{
				writer.WritePropertyName("user_dob_month"u8);
				writer.WriteNumberValue(UserDobMonth.Value);
			}
			if (UserDobYear is not null)
			{
				writer.WritePropertyName("user_dob_year"u8);
				writer.WriteNumberValue(UserDobYear.Value);
			}
			...
			if (SecretAnswerType is not null)
			{
				writer.WritePropertyName("secret_answer_type"u8);
				writer.WriteNumberValue(SecretAnswerType.Value);
			}
			if (ShortLink is not null)
			{
				writer.WritePropertyName("short_link"u8);
				writer.WriteStringValue(ShortLink);
			}
			if (LanguageId is not null)
			{
				writer.WritePropertyName("language_id"u8);
				writer.WriteNumberValue((long)LanguageId.Value);
			}
			if (Gender is not null)
			{
				writer.WritePropertyName("gender"u8);
				writer.WriteStringValue(Gender.Value.ToJsonValue());
			}
			if (Timezone is not null)
			{
				writer.WritePropertyName("timezone"u8);
				writer.WriteStringValue(Timezone.Value.ToJsonValue());
			}
			if (ReceiveAdminEmail is not null)
			{
				writer.WritePropertyName("receive_admin_email"u8);
				writer.WriteBooleanValue(ReceiveAdminEmail.Value);
			}
			if (ActivityVisible is not null)
			{
				writer.WritePropertyName("activity_visible"u8);
				writer.WriteBooleanValue(ActivityVisible.Value);
			}
			if (ShowDobDate is not null)
			{
				writer.WritePropertyName("show_dob_date"u8);
				writer.WriteBooleanValue(ShowDobDate.Value);
			}
			if (ShowDobYear is not null)
			{
				writer.WritePropertyName("show_dob_year"u8);
				writer.WriteBooleanValue(ShowDobYear.Value);
			}
			if (HideUsernameChangeLogs is not null)
			{
				writer.WritePropertyName("hide_username_change_logs"u8);
				writer.WriteBooleanValue(HideUsernameChangeLogs.Value);
			}
			if (AllowViewProfile is not null)
			{
				writer.WritePropertyName("allow_view_profile"u8);
				writer.WriteStringValue(AllowViewProfile.Value.ToJsonValue());
			}
			if (AllowPostProfile is not null)
			{
				writer.WritePropertyName("allow_post_profile"u8);
				writer.WriteStringValue(AllowPostProfile.Value.ToJsonValue());
			}
			if (AllowSendPersonalConversation is not null)
			{
				writer.WritePropertyName("allow_send_personal_conversation"u8);
				writer.WriteStringValue(AllowSendPersonalConversation.Value.ToJsonValue());
			}
			if (AllowInviteGroup is not null)
			{
				writer.WritePropertyName("allow_invite_group"u8);
				writer.WriteStringValue(AllowInviteGroup.Value.ToJsonValue());
			}
			if (AllowReceiveNewsFeed is not null)
			{
				writer.WritePropertyName("allow_receive_news_feed"u8);
				writer.WriteStringValue(AllowReceiveNewsFeed.Value.ToJsonValue());
			}
			if (Alert is not null)
			{
				writer.WritePropertyName("alert"u8);
				writer.WriteStartObject();
				foreach (var __wkv in Alert)
				{
					writer.WritePropertyName(__wkv.Key);
					writer.WriteBooleanValue(__wkv.Value.GetValueOrDefault());
				}
				writer.WriteEndObject();
			}
...
)
{
	...
	public sealed record UsersAvatarUploadBody
	{
		...
		public void WriteTo(Utf8JsonWriter writer)
		{
			...
			writer.WriteBase64StringValue(Avatar);
			if (X is not null)
			{
			...
			if (Crop is not null)
			{
				...
				writer.WriteNumberValue(Crop.Value);
			}
			writer.WriteEndObject();
		}
	}
	...
	public sealed record UsersBackgroundUploadBody
	{
		...
		public void WriteTo(Utf8JsonWriter writer)
		{
			...
			writer.WriteBase64StringValue(Background);
			if (X is not null)
			{
				writer.WritePropertyName("x"u8);
				writer.WriteNumberValue(X.Value);
...
)
{
	...
	public sealed record UsersLikesParams
	{
		...
		public void WriteTo(Utf8JsonWriter writer)
		{
			...
			if (LikeType is not null)
			{
				writer.WritePropertyName("like_type"u8);
				writer.WriteStringValue(LikeType.Value.ToJsonValue());
			}
			if (Type is not null)
			{
				writer.WritePropertyName("type"u8);
			...
			if (ContentType is not null)
			{
				...
				writer.WriteStringValue(ContentType.Value.ToJsonValue());
			}
			if (SearchUserId is not null)
			{
				writer.WritePropertyName("search_user_id"u8);
				writer.WriteNumberValue(SearchUserId.Value);
			}
			if (Stats is not null)
			{
				writer.WritePropertyName("stats"u8);
				writer.WriteBooleanValue(Stats.Value);
			}
			writer.WriteEndObject();
		}
	}
	...
	public sealed record UsersLikesResponse(
		...
		[property: JsonPropertyName("likes")] Dictionary<string, UsersLikesResponseLikes> Likes,
		[property: JsonPropertyName("system_info")] Resp_SystemInfo SystemInfo
	)
	{
		...
		internal static UsersLikesResponse ReadFromReader(ref Utf8JsonReader reader)
		{
			...
			string v2 = null!;
			long v3 = default;
			Dictionary<string, UsersLikesResponseLikes> v4 = null!;
			...
			while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
			{
				...
				else if (reader.ValueTextEquals("likes"u8))
				{
					...
					{
						var __dict = new Dictionary<string, UsersLikesResponseLikes>();
						while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
						{
							if (reader.TokenType != JsonTokenType.PropertyName) continue;
							var __key = reader.GetString()!;
							reader.Read();
							var __val = UsersLikesResponseLikes.ReadFromReader(ref reader);
							__dict[__key] = __val;
						}
						v4 = __dict;
					}
...
)
{
	...
	internal static UsersLikesResponseLikes ReadFromReader(ref Utf8JsonReader reader)
	{
		...
		return new UsersLikesResponseLikes(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10);
	}
}
...
)
{
	...
	public sealed record UsersIgnoreEditParams
	{
		...
		{
			writer.WriteStartObject();
			if (IgnoreConversations is not null)
			{
				writer.WritePropertyName("ignore_conversations"u8);
				writer.WriteBooleanValue(IgnoreConversations.Value);
			}
			if (IgnoreContent is not null)
			{
				writer.WritePropertyName("ignore_content"u8);
				writer.WriteBooleanValue(IgnoreContent.Value);
			}
			if (RestrictViewProfile is not null)
			{
				writer.WritePropertyName("restrict_view_profile"u8);
				writer.WriteBooleanValue(RestrictViewProfile.Value);
			}
			writer.WriteEndObject();
		}
	}
...
)
{
	...
	public sealed record UsersTrophiesResponse(
		...
		[property: JsonPropertyName("trophyProgresses")] List<UsersTrophiesResponseTrophyProgresses> TrophyProgresses,
		[property: JsonPropertyName("system_info")] Resp_SystemInfo SystemInfo
	)
	{
		...
		internal static UsersTrophiesResponse ReadFromReader(ref Utf8JsonReader reader)
		{
			...
			List<UsersTrophiesResponseTrophyProgresses> v1 = null!;
			Resp_SystemInfo v2 = null!;
			while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
			{
				if (reader.TokenType != JsonTokenType.PropertyName) continue;
				...
				else if (reader.ValueTextEquals("trophyProgresses"u8))
				{
					reader.Read();
					if (reader.TokenType == JsonTokenType.StartArray)
					{
						var __lst = new List<UsersTrophiesResponseTrophyProgresses>();
						while (reader.Read() && reader.TokenType != JsonTokenType.EndArray)
						{
							var __item = UsersTrophiesResponseTrophyProgresses.ReadFromReader(ref reader);
							__lst.Add(__item);
						}
						v1 = __lst;
					}
			...
			return new UsersTrophiesResponse(v0, v1, v2);
		}
	}

public sealed record UsersTrophiesResponseTrophiesAvailableLevels(
...
)
{
	...
	/// <summary>Deserialize from raw UTF-8 JSON bytes — no JsonDocument, no reflection.</summary>
	public static UsersTrophiesResponseTrophiesAvailableLevels ReadFrom(ReadOnlyMemory<byte> json)
	{
		var reader = new Utf8JsonReader(json.Span);
		reader.Read(); // advance to StartObject
		return ReadFromReader(ref reader);
	...
	internal static UsersTrophiesResponseTrophiesAvailableLevels ReadFromReader(ref Utf8JsonReader reader)
	{
		string v0 = null!;
		string v1 = null!;
		while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
		...
		return new UsersTrophiesResponseTrophiesAvailableLevels(v0, v1);
	}
}
...
public sealed record UsersTrophiesResponseTrophies(
	...
	[property: JsonPropertyName("award_date")] long AwardDate,
	[property: JsonPropertyName("rarity")] string Rarity,
	[property: JsonPropertyName("usersHasTrophyPercentage")] double UsersHasTrophyPercentage,
	[property: JsonPropertyName("rarityPhrase")] string RarityPhrase,
	[property: JsonPropertyName("trophy_counter")] long TrophyCounter,
	[property: JsonPropertyName("counter")] string? Counter,
	[property: JsonPropertyName("available_levels")] Dictionary<string, UsersTrophiesResponseTrophiesAvailableLevels>? AvailableLevels,
	[property: JsonPropertyName("current_display_level")] long? CurrentDisplayLevel
)
{
	...
	internal static UsersTrophiesResponseTrophies ReadFromReader(ref Utf8JsonReader reader)
	{
		...
		while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
		{
			...
			else if (reader.ValueTextEquals("award_date"u8))
			{
				reader.Read();
				v4 = reader.GetInt64();
			}
			else if (reader.ValueTextEquals("rarity"u8))
			{
				reader.Read();
				v5 = reader.GetString()!;
			}
			else if (reader.ValueTextEquals("usersHasTrophyPercentage"u8))
			{
				reader.Read();
				v6 = reader.GetDouble();
			}
			else if (reader.ValueTextEquals("rarityPhrase"u8))
			{
				reader.Read();
				v7 = reader.GetString()!;
			}
			else if (reader.ValueTextEquals("trophy_counter"u8))
			{
				reader.Read();
				v8 = reader.GetInt64();
			}
			...
			else if (reader.ValueTextEquals("available_levels"u8))
			{
				...
				if (reader.TokenType == JsonTokenType.StartObject)
				{
					var __dict = new Dictionary<string, UsersTrophiesResponseTrophiesAvailableLevels>();
					while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
					{
						if (reader.TokenType != JsonTokenType.PropertyName) continue;
						var __key = reader.GetString()!;
						reader.Read();
						var __val = UsersTrophiesResponseTrophiesAvailableLevels.ReadFromReader(ref reader);
						__dict[__key] = __val;
					}
					v10 = __dict;
				}
		...
		return new UsersTrophiesResponseTrophies(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11);
	}
}

public sealed record UsersTrophiesResponseTrophyProgressesProgress(
	[property: JsonPropertyName("left")] long Left,
	[property: JsonPropertyName("need_total")] string NeedTotal,
	[property: JsonPropertyName("needTotalPhrase")] string NeedTotalPhrase,
	[property: JsonPropertyName("leftPhrase")] string LeftPhrase,
	[property: JsonPropertyName("completed_total")] long CompletedTotal,
	[property: JsonPropertyName("percents_completed")] double PercentsCompleted
)
{

	/// <summary>Deserialize from raw UTF-8 JSON bytes — no JsonDocument, no reflection.</summary>
	public static UsersTrophiesResponseTrophyProgressesProgress ReadFrom(ReadOnlyMemory<byte> json)
	{
		var reader = new Utf8JsonReader(json.Span);
		reader.Read(); // advance to StartObject
		return ReadFromReader(ref reader);
	...
	internal static UsersTrophiesResponseTrophyProgressesProgress ReadFromReader(ref Utf8JsonReader reader)
	{
		long v0 = default;
		string v1 = null!;
		string v2 = null!;
		...
		while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
		{
			...
			if (reader.ValueTextEquals("left"u8))
			{
				reader.Read();
				v0 = reader.GetInt64();
			}
			else if (reader.ValueTextEquals("need_total"u8))
			{
				reader.Read();
				v1 = reader.GetString()!;
			}
			else if (reader.ValueTextEquals("needTotalPhrase"u8))
			{
				reader.Read();
				v2 = reader.GetString()!;
			}
			else if (reader.ValueTextEquals("leftPhrase"u8))
			{
				reader.Read();
				v3 = reader.GetString()!;
			}
			else if (reader.ValueTextEquals("completed_total"u8))
			{
				reader.Read();
				v4 = reader.GetInt64();
			}
			else if (reader.ValueTextEquals("percents_completed"u8))
			{
				reader.Read();
				v5 = reader.GetDouble();
			}
		...
		return new UsersTrophiesResponseTrophyProgressesProgress(v0, v1, v2, v3, v4, v5);
	}
}

public sealed record UsersTrophiesResponseTrophyProgresses(
	[property: JsonPropertyName("trophy_id")] long TrophyId,
	[property: JsonPropertyName("title")] string Title,
	[property: JsonPropertyName("trophy_points")] long TrophyPoints,
	[property: JsonPropertyName("description")] string Description,
	[property: JsonPropertyName("trophy_redirect_url")] string TrophyRedirectUrl,
	[property: JsonPropertyName("trophy_url")] string TrophyUrl,
	[property: JsonPropertyName("trophy_max_points")] long TrophyMaxPoints,
	[property: JsonPropertyName("awardable")] long Awardable,
	[property: JsonPropertyName("percents_completed")] double PercentsCompleted,
	[property: JsonPropertyName("progress")] List<UsersTrophiesResponseTrophyProgressesProgress> Progress,
	[property: JsonPropertyName("leftPhrases")] List<string> LeftPhrases,
	[property: JsonPropertyName("leftPhrase")] string LeftPhrase,
	[property: JsonPropertyName("rarity")] string Rarity,
	[property: JsonPropertyName("usersHasTrophyPercentage")] long UsersHasTrophyPercentage,
	[property: JsonPropertyName("rarityPhrase")] string RarityPhrase
)
{

	/// <summary>Deserialize from raw UTF-8 JSON bytes — no JsonDocument, no reflection.</summary>
	public static UsersTrophiesResponseTrophyProgresses ReadFrom(ReadOnlyMemory<byte> json)
	{
		var reader = new Utf8JsonReader(json.Span);
		reader.Read(); // advance to StartObject
		return ReadFromReader(ref reader);
	...
	internal static UsersTrophiesResponseTrophyProgresses ReadFromReader(ref Utf8JsonReader reader)
	{
		long v0 = default;
		string v1 = null!;
		long v2 = default;
		...
		long v7 = default;
		double v8 = default;
		List<UsersTrophiesResponseTrophyProgressesProgress> v9 = null!;
		List<string> v10 = null!;
		string v11 = null!;
		string v12 = null!;
		long v13 = default;
		string v14 = null!;
		while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
		{
			...
			else if (reader.ValueTextEquals("trophy_redirect_url"u8))
			{
				reader.Read();
				v4 = reader.GetString()!;
			}
			...
			else if (reader.ValueTextEquals("trophy_max_points"u8))
			{
				reader.Read();
				v6 = reader.GetInt64();
			}
			else if (reader.ValueTextEquals("awardable"u8))
			{
				reader.Read();
				v7 = reader.GetInt64();
			}
			...
			else if (reader.ValueTextEquals("progress"u8))
			{
				reader.Read();
				if (reader.TokenType == JsonTokenType.StartArray)
				{
					var __lst = new List<UsersTrophiesResponseTrophyProgressesProgress>();
					while (reader.Read() && reader.TokenType != JsonTokenType.EndArray)
					{
						var __item = UsersTrophiesResponseTrophyProgressesProgress.ReadFromReader(ref reader);
						__lst.Add(__item);
					}
					v9 = __lst;
				}
			}
			else if (reader.ValueTextEquals("leftPhrases"u8))
			{
				reader.Read();
				if (reader.TokenType == JsonTokenType.StartArray)
				{
		...
		return new UsersTrophiesResponseTrophyProgresses(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14);
	}
}
